...
public class TopLevelSettings extends DashboardFragment implements SplitLayoutListener,
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.cardinal_top_level_settings;
    }
	...
	for (int i = 0; i < screen.getPreferenceCount(); i++) {
            ...
            if (isValid && pref.getLayoutResource() != R.layout.cardinal_dashboard_preference_top &&
                pref.getLayoutResource() != R.layout.cardinal_dashboard_preference_full &&
                pref.getLayoutResource() != R.layout.cardinal_dashboard_preference_phone &&
                pref.getLayoutResource() != R.layout.cardinal_dashboard_preference_bottom) {
                pref.setLayoutResource(R.layout.cardinal_dashboard_preference_middle);
            }
        }
	if (screen == null) {
            return;
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.cardinal_top_level_settings) {
