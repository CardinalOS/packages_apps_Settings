	...
	final PreferenceScreen screen = getPreferenceScreen();
        ...
        for (int i = 0; i < count; i++) {
 	    ...
 	    String key = preference.getKey();
	        ...
	        preference.setLayoutResource(R.layout.cardinal_cardview_single_left);
	        }
            if (key.equals("top_level_cardinalery")){
                preference.setLayoutResource(R.layout.cardinal_cardview_single_right);
            }
            if (key.equals("airplane_mode")){
                preference.setLayoutResource(R.layout.cardinal_cardview_top_switch);
            }
            if (key.equals("internet_settings")){
                preference.setLayoutResource(R.layout.cardinal_cardview_middle);
            }
            if (key.equals("tether_settings")){
                preference.setLayoutResource(R.layout.cardinal_cardview_middle);
            }
            if (key.equals("top_level_connected_devices")){
                preference.setLayoutResource(R.layout.cardinal_cardview_bottom);
            }
            if (key.equals("top_level_apps")){
                preference.setLayoutResource(R.layout.cardinal_cardview_top);
            }
